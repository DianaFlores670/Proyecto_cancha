...
const Dashboard = () => {
  ...
  if (error) {
    return (
      <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 m-4 rounded-lg shadow-sm" role="alert">
  ...
  return (
    <div className="min-h-screen bg-white p-6 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Header */}
        <div className="bg-white rounded-2xl shadow-sm p-8 mb-8 border border-[#23475F]/20">
          <div className="flex items-center gap-6">
            {company.logo_imagen && (
              <img
                src={getImageUrl(company.logo_imagen)} // ✅ CORREGIDO: Usar getImageUrl
                alt={`${company.nombre_sistema} logo`}
                className="h-20 w-20 object-contain rounded-full border-4 border-[#01CD6C] shadow-md"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          {/* Misión y Visión */}
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-[#23475F]/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-[#23475F]/20">
            ...
            <div className="space-y-4">
              {company.imagen_1 && (
                <img
                  src={getImageUrl(company.imagen_1)} // ✅ CORREGIDO
                  alt="Servicio 1"
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-[#23475F]/20">
            ...
            <div className="space-y-4">
              {company.imagen_2 && (
                <img
                  src={getImageUrl(company.imagen_2)} // ✅ CORREGIDO
                  alt="Servicio 2"
                  className="w-full h-40 object-cover rounded-lg mb-4"
                  onError={handleImageError}
                />
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 border border-[#23475F]/20">
            ...
            <div className="space-y-4">
              {company.imagen_3 && (
                <img
                  src={getImageUrl(company.imagen_3)} // ✅ CORREGIDO
                  alt="Servicio 3"
                  className="w-full h-40 object-cover rounded-lg mb-4"
                  onError={handleImageError}
                />
        ...
        {company.imagen_hero && (
          <div className="mb-8">
            <div className="bg-white rounded-2xl shadow-sm p-8 border border-[#23475F]/20">
              ...
              <img
                src={getImageUrl(company.imagen_hero)} // ✅ CORREGIDO
                alt="Imagen principal de la empresa"
                className="w-10 h-full object-cover rounded-xl shadow-sm"
                onError={handleImageError}
              />
            </div>
          </div>
        ...
        <footer className="bg-[#0F2634] text-white rounded-2xl p-8 mt-8 shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            
            {/* Información de la Empresa */}
            <div className="flex flex-col justify-center">
              <h4 className="text-2xl font-bold mb-4 text-white">{company.nombre_sistema}</h4>
            ...
            <div className="flex flex-col justify-center space-y-3">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-white">{company.correo_empresa || 'No disponible'}</p>
                </div>
              </div>
              <div className="flex items-center">
                <span className="text-[#01CD6C] mr-3">📞</span>
                <div>
                  ...
                  <p className="text-white">{company.telefono || 'No disponible'}</p>
                </div>
              </div>
              <div className="flex items-center">
                <span className="text-[#01CD6C] mr-3">📍</span>
                <div>
                  ...
                  <p className="text-white">{company.direccion || 'No disponible'}</p>
                </div>
              </div>
            </div>
          </div>
