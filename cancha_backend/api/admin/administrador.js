...
const crearAdministrador = async (datosAdministrador) => {
  try {
    ...
    if (!datosAdministrador.contrasena || datosAdministrador.contrasena.trim() === '') {
      datosAdministrador.contrasena = '123456';
    }
    ...
    const valuesAdmin = [
      ...
      null  // ultimo_login inicial null
    ];
