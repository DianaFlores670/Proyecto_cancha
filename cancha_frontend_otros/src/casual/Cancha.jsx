  ...
  return (
    <div className="min-h-screen bg-[#F6F8FA] p-4 font-sans">
      ...
      <div className="max-w-7xl mx-auto mt-32">
        <h1 className="text-3xl font-extrabold tracking-tight text-[#0F2634] mb-10">Canchas Disponibles</h1>
          ...
          {canchas.map((cancha) => (
            <div key={cancha.id_cancha}
              ...
              <p className="text-[#23475F] text-sm mb-1">
                <span className="font-semibold">Espacio:</span> {cancha.espacio_nombre}
              </p>
              ...
              {cancha.disciplinas?.length > 0 && (
                <p className="text-[#23475F] text-sm mb-4">
                  <span className="font-semibold">Disciplinas:</span> {cancha.disciplinas.map(d => d.nombre).join(', ')}
                </p>
              )}

              <button
                onClick={() => isLoggedIn ? fetchCanchaDetails(cancha.id_cancha) : handleOpenAccessModal()}
    ...
    <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden">
      ...
      <div className="px-8 pt-10 pb-8 flex flex-col items-center text-center gap-5">
        ...
        <p className="text-sm text-[#23475F] max-w-xs leading-relaxed">
          ...
          <span className="font-semibold text-[#0F2634]"> precios promocionales exclusivos </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-3 text-sm">
            <p className="text-[#23475F]">
              ...
              <span className="text-[#01CD6C] font-semibold">{selectedCancha.espacio_nombre}</span>
            </p>

            <p className="text-[#23475F]">
              <span className="font-semibold text-[#0F2634]">Direccion:</span> {selectedCancha.espacio_direccion}
            </p>

            <p className="text-[#23475F]">
              <span className="font-semibold text-[#0F2634]">Ubicacion Exacta:</span> {selectedCancha.ubicacion}
            </p>

            <p className="text-[#23475F]">
              <span className="font-semibold text-[#0F2634]">ID Cancha:</span>{' '}
              <span className="text-[#01CD6C] font-mono font-semibold">{selectedCancha.id_cancha}</span>
            </p>
          </div>
          ...
          <div className="space-y-3 text-center">
            ...
            {selectedCancha.capacidad && (
              <p className="p-3 rounded-xl bg-[#01CD6C]/10 font-semibold text-[#0F2634]">
                Capacidad: <span className="text-[#01CD6C]">{selectedCancha.capacidad} personas</span>
              </p>
            )}

            {selectedCancha.estado && (
              <p className={`p-3 rounded-xl font-semibold ${
