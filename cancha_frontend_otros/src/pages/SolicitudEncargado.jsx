  ...
  const fetchSolicitudes = async (params = {}) => {
    ...
    try {
      ...
      if (res.data?.exito) {
        ...
        setError(res.data?.mensaje || "Error al traer solicitudes");
      }
    } catch {
  ...
  const confirmApprove = async () => {
    ...
    try {
      ...
      if (r.data?.exito) {
        ...
        setTimeout(() => setApproveOpen(false), 250);
        fetchSolicitudes(estado ? { estado } : {});
      } else {
  ...
  const confirmReject = async () => {
    ...
    try {
      ...
      if (r.data?.exito) {
        ...
        setTimeout(() => setRejectOpen(false), 250);
        fetchSolicitudes(estado ? { estado } : {});
      } else {
      ...
      {success && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-white w-64 p-5 rounded-2xl shadow-xl text-center animate-scaleIn">
            <h3 className="font-bold text-[#23475F] text-lg mb-2">Éxito</h3>
